...
<div id="sidebar">
  <div id="russell" class="about">
    <h2>About Russell</h2>
    <p><img height="206" width="265" class="alignnone size-full wp-image-349" title="Russell closeup" alt="Russell closeup" src="<?php echo get_site_url(); ?>/wp-content/uploads/sites/2/2009/09/russell-closeup.jpg"/> Russell is a self-proclaimed computer geek who enjoys building websites, blogging, and collecting funny t-shirts. Outside of cyberspace he can be found taking pictures with his digital SLR or snowboarding in the winter time.</p>
    <ul>
  ...
  <div id="kristina" class="about">
    ...
    <p><img height="284" width="265" class="alignnone size-full wp-image-350" title="Kristina closeup" alt="Kristina closeup" src="<?php echo get_site_url(); ?>/wp-content/uploads/sites/2/2009/09/kristina-closeup.jpg"/> Kristina is a craft-a-holic including card making, sewing, and candlemaking. She also enjoys the intricacies of baking and spending summer days tanning on the beach.</p>
    <ul>
